...
<html lang="en">
    <head>
        <!-- Title -->
        <title>Six Senses Uluwatu | Dinas Pariwisata Provinsi Bali</title>
                ...
                <div class="container">
                    <nav class="py-3" aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter mb-0 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="#">Badung Hotels</a></li>
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">Six Senses Uluwatu</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="d-block d-md-flex flex-center-between align-items-start mb-2">
                            <div class="mb-3">
                                ...
                                <div class="d-block d-md-flex flex-horizontal-center mb-2 mb-md-0">
                                    <h4 class="font-size-23 font-weight-bold mb-1">Six Senses Uluwatu</h4>
                                ...
                                <div class="d-block d-md-flex flex-horizontal-center font-size-14 text-gray-1">
                                    <i class="icon flaticon-placeholder mr-2 font-size-20"></i> Jalan Goa Lempeh, Uluwatu, Bali - 80361, Indonesia, Uluwatu, Bali, Indonesia, 80361 
                        ...
                        <div class="pb-4 mb-2">
                            <div class="position-relative">
                                ...
                                <div id="sliderSyncingNav" class="js-slick-carousel u-slick mb-2"
                                    ...
                                    <div class="js-slide">
                                        <img class="img-fluid border-radius-3" src="../../assets/img/960x490/img7.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid border-radius-3" src="../../assets/img/960x490/img8.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid border-radius-3" src="../../assets/img/960x490/img9.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid border-radius-3" src="../../assets/img/960x490/img10.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid border-radius-3" src="../../assets/img/960x490/img11.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid border-radius-3" src="../../assets/img/960x490/img12.jpg" alt="Image Description">
                                    </div>
                                </div>
                                ...
                                <div id="sliderSyncingThumb" class="js-slick-carousel u-slick u-slick--gutters-4 u-slick--transform-off"
                                    ...
                                    <div class="js-slide" style="cursor: pointer;">
                                        <img class="img-fluid border-radius-3 height-110" src="../../assets/img/960x490/img7.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide" style="cursor: pointer;">
                                        <img class="img-fluid border-radius-3 height-110" src="../../assets/img/960x490/img8.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide" style="cursor: pointer;">
                                        <img class="img-fluid border-radius-3 height-110" src="../../assets/img/960x490/img9.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide" style="cursor: pointer;">
                                        <img class="img-fluid border-radius-3 height-110" src="../../assets/img/960x490/img10.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide" style="cursor: pointer;">
                                        <img class="img-fluid border-radius-3 height-110" src="../../assets/img/960x490/img11.jpg" alt="Image Description">
                                    </div>
                                    <div class="js-slide" style="cursor: pointer;">
                                        <img class="img-fluid border-radius-3 height-110" src="../../assets/img/960x490/img12.jpg" alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Images Carousel -->
                            </div>
                                        ...
                                        <div class="col col-md-7 col-lg-7 col-xl-5 flex-horizontal-center pl-xl-0">
                                            <div class="w-100 position-relative m-4 m-md-0">
                                                ...
                                                <div class="mt-1 pt-2">
                                                    ...
                                                    <!-- On Target Modal -->
                                                    <a class="font-size-14 text-underline d-block" href="#ontargetModal"
                                                                ...
                                                                <div class="col-xl-9">
                                                                    <div class="js-slick-carousel u-slick rounded-right height-760 overflow-hidden width-960 ml-auto"
                                                                        ...
                                                                        <div class="js-slide gradient-overlay-half-bg-gradient-v7">
                                                                            <img class="img-fluid w-100 position-relative" src="../../assets/img/960x760/img1.jpg" alt="Image Description">
                        ...
                        <div class="border-bottom py-4">
                            ...
                            <div class="media flex-column flex-md-row align-items-center align-items-md-start mb-0">
                                <div class="mr-md-5">
                                    <a class="d-block" href="#">
                                        <img class="img-fluid mb-3 mb-md-0 rounded-circle" src="../../assets/img/85x85/img2.jpg" alt="Image-Description">
                                    </a>
                                </div>
                                <div class="media-body text-center text-md-left">
                                    <div class="mb-4">
                        ...
                        <div class="js-slick-carousel u-slick u-slick--equal-height u-slick--gutters-3"
                                ...
                                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                                    <div class="position-relative">
                                        <a href="../hotels/hotel-single-v1.html" class="d-block gradient-overlay-half-bg-gradient-v5">
                                            <img class="card-img-top" src="../../assets/img/300x230/img9.jpg" alt="Image Description">
                                        </a>
                                ...
                                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                                    <div class="position-relative">
                                        <a href="../hotels/hotel-single-v2.html" class="d-block gradient-overlay-half-bg-gradient-v5">
                                            <img class="card-img-top" src="../../assets/img/300x230/img10.jpg" alt="Image Description">
                                        </a>
                                        <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                <span class="flaticon-heart-1 font-size-20"></span>
                                ...
                                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                                    <div class="position-relative">
                                        <a href="../hotels/hotel-single-v3.html" class="d-block gradient-overlay-half-bg-gradient-v5">
                                            <img class="card-img-top" src="../../assets/img/300x230/img12.jpg" alt="Image Description">
                                        </a>
                                        <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                <span class="flaticon-heart-1 font-size-20"></span>
                            ...
                            <div class="js-slide py-3">
                                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                                    <div class="position-relative">
                                        <a href="../hotels/hotel-single-v2.html" class="d-block gradient-overlay-half-bg-gradient-v5">
                                            <img class="card-img-top" src="../../assets/img/300x230/img11.jpg" alt="Image Description">
                                        </a>
                                        <div class="position-absolute top-0 right-0 pt-3 pr-3">
                                            <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Save for later">
                                                <span class="flaticon-heart-1 font-size-20"></span>
                            ...
                            <div class="js-slide py-3">
                                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                                    ...
                                    <div class="card-body px-4 pt-2 pb-3">
                                        ...
                                        <a href="../hotels/hotel-single-v3.html" class="card-title font-size-17 font-weight-medium text-dark">Empire Prestige Causeway Bay</a>
                                        <div class="mt-2 mb-3">
                                            <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                                            <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                                        </div>
                            ...
                            <div class="js-slide py-3">
                                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                                    ...
                                    <div class="card-body px-4 pt-2 pb-3">
                                        ...
                                        <a href="../hotels/hotel-single-v1.html" class="card-title font-size-17 font-weight-medium text-dark">New York Marriott Downtown</a>
                                        <div class="mt-2 mb-3">
                                            <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                                            <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                                        </div>
